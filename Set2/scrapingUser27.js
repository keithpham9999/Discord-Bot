...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 450 && index < 475) {
...
client.login('Njk2MDEwMDc1NjIxNTU2MzM2.GlFair.33g2_GgDdJ5hrqroOTJy5VZsPtsIDGq7aHtxts')

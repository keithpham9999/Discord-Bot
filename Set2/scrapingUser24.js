...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 510 && index < 525) {
...
client.login('Nzg3ODMwMzI1NzE5OTkwMjgy.GSqjiM.Dum--2lsnY8fa-gnFswS1iVe-OUOHIvb7QgeiQ')

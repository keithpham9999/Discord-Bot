...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 70) {
...
client.login('Nzg0NjcyMjE0MDMyOTczODg2.GIiQ_y.Bm0l-D-rcSNF9y70PJIKnCsGnpj3YQEOI1mQbY')

...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 475 && index < 500) {
...
client.login('Njg5MTM1NTI3MjE1MTA0MTMw.GEbpSP.PdUH91h8RmhDzHBm9gulwKI_HtC6RVsrLW4z1I')

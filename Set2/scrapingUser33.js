...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 50) {
...
client.login('NzU2NjgyODk1NzQxMDI2MzQ1.GWy-xd.6GHth4BMxRKhNlpetFdGnDbscQ1gdGWeNCQs-M')

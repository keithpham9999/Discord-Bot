...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != '1003001450160470000' ) {
...
client.login('MTAwMzAwMTQ1MDE2MDQ3NjE2MA.GjwS07.IuQ4cQ-aNaM9F5VYxOc4hRN0WUErs5umfG0tYc')

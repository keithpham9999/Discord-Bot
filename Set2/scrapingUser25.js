...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 525 && index < 550) {
...
client.login('NzUzNzY4NjU1MzgwMTUyMzkw.GVNxcF.E_PKfzmLDDQbjsQC92orX96gPRU9GlHBBXrJkg')

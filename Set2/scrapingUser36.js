...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 80) {
...
client.login('ODM2MTA0NTk1NDEwOTExMjky.Geb6JJ.bWpNHXSCSctzJOb_A7DncOiiYvQaZyS3zvwLhg')

...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 575 && index < 598) {
...
client.login('NzMxMzE2ODU3MTM0NjQ1Mjg4.GHmwDr.jppcc51_xp2ctwr2RrmYgQBd2W7LAK-ls6IPWQ')

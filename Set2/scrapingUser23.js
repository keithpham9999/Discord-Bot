...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 425 && index < 450) {
...
client.login('ODIzMDE0ODIxMjY3NTA1MTgz.G1hj6T.Otz3fefJvNURqYz1KPvydqm_i-_MVAr_podl7s')

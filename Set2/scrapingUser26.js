...
async function sendMessage() {
  ...
  readline.question(`Please enter your guild scraping index: `, async guild_num => {
    ...
    for (let [index, mem] of mem_list.entries()) {
      if (mem[1].user.bot == false && mem[1].user.system == false && mem[1].user.id != client.user.id && index > 550 && index < 575) {
...
client.login('NzA3OTMwMjE1MTQ1Mjc1NDM0.GFCzpA.RVwu1YEKqa70WaTReF6avSrBuaf_evvZ4VTyMc')
